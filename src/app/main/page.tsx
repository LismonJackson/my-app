    ...
    <>
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main>
          ...
          {/* First Section */}
          <section className="min-h-screen bg-cover bg-center flex flex-col justify-center items-center py-8 md:py-12" style={{ backgroundImage: `url('/NewBackground.png')` }}>
            <div className={`text-center ${animations.logoContainer}`}>
              ...
              <button className="font_knewave text-2xl mt-4 px-6 py-3 bg-black text-white font-semibold rounded-lg shadow-md hover:bg-slate-800 transition duration-300">Buy $WONK</button>
            </div>
          </section>

          <Slide />
          {/* Second Section */}
          <section className={`bg-cover bg-center flex justify-center items-center ${styles.portraitResponsive}`} style={{ background: `url('/NewBackground.png')` }}>
          ...
          <Divider />
          {/* Third Section */}
          <section className="min-h-screen bg-cover bg-center flex justify-center items-center py-8 md:py-12" style={{ backgroundImage: `url('/NewBackground.png')`, minHeight: '100vh', height: 'auto' }}>
            <div className="flex flex-col md:flex-row justify-center items-center">
              <div className="md:mr-10 md:mt-20 max-w-md md:pt-10 lg:pt-0 p-4 md:p-0 text-center md:text-left">
                ...
                <button className="font_knewave mt-4 px-6 py-3 bg-black text-white font-semibold rounded-lg shadow-md hover:bg-slate-800 transition duration-300">
          ...
          <Slide />
          {/* Fourth Section */}
          <section className="min-h-screen bg-cover bg-center flex flex-col justify-center items-center py-8 md:py-12" style={{ background: `url('/NewBackground.png')` }}>
            <div className="flex flex-col md:flex-row justify-center items-center">
              <div className={`flex flex-col md:mr-10 justify-center items-center ${styles.Image_responsiveMode_1}`}>
          ...
          <section className="min-h-screen bg-cover bg-center flex flex-col justify-center items-center py-8 md:py-12" style={{ background: `url('/NewBackground.png')` }}>
            <div className="container mx-auto px-4 md:px-8 items-center text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-black bg-opacity-70 rounded-lg p-6 text-white text-center">
                  <h3 className="fontdiner_sm text-lg md:text-xl font-bold mb-4">PHASE 1</h3>
                  <p className="font_amaranth_sm text-base md:text-lg text-left">
                ...
                <div className="bg-black bg-opacity-70 rounded-lg p-6 text-white text-center">
                  <h3 className="fontdiner_sm text-lg md:text-xl font-bold mb-4">PHASE 2</h3>
                  <p className="font_amaranth_sm text-base md:text-lg text-left">
                ...
                <div className="bg-black bg-opacity-70 rounded-lg p-6 text-white text-center">
                  <h3 className="fontdiner_sm text-lg md:text-xl font-bold mb-4">PHASE 3</h3>
                  <p className="font_amaranth_sm text-base md:text-lg text-left">
          ...
          {/* Sixth Section */}
          <section id="sec6" className="min-h-screen bg-cover bg-center flex justify-center items-center py-8 md:py-12" style={{ backgroundImage: `url('/NewBackground.png')` }}>
            <div className="flex flex-col md:flex-row justify-center items-center">
              <div className={`flex flex-col md:mr-10 justify-center items-center ${styles.Image_responsiveMode_1}`}>
                <Image src="/coins.png" alt="Logo" className={`mx-auto ${styles.imageShadow}`} width={600} height={600} />
              </div>
              <div className="md:ml-10 md:mt-20 max-w-md md:pt-10 lg:pt-0 p-4 md:p-0 text-center md:text-left">
                <div className="bg-black bg-opacity-70 rounded-lg p-8 text-white">
                  <h1 className="fontdiner_sm text-3xl md:text-4xl font-bold mb-8">PRESALE INFO</h1>
                  <p className="font_amaranth_sm text-lg md:text-xl mb-4"><strong>Minimum contribution:</strong> 0.5 SOL</p>
                  <p className="font_amaranth_sm text-lg md:text-xl mb-4"><strong>Presale Duration:</strong> 24 hours</p>
                  <p className="font_amaranth_sm text-lg md:text-xl mb-4"><strong>Hard cap:</strong> 500 SOL</p>
                  <p className="font_amaranth_sm text-lg md:text-xl mb-8"><strong>Launch takes place 24 hours after the presale ends, exact time will be random to avoid token snipers that could potentially pump and dump the price action.</strong></p>
